...
def run_evaluation():
    ...
    def parse_list(s):
        ...
        """
        try:
            # Use json.loads for reliable parsing of JSON-formatted strings
            return json.loads(s)
        except json.JSONDecodeError:
            try:
                ...
                # As a last resort, split by comma and remove extra quotes
    ...
    def evaluate_attribute(input_file, output_dir, attribute):
        ...
        # Extract lists
        true_values = restored_df['true'].to_list()  # List of lists: [["doi", "true_value"], ...]
