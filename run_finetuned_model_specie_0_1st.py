...
# Define the species attribute information
species_info = {
    ...
    'prompt': (
        ...
        "[{\"collectionSpecie\": \"Example Species 1\"}, {\"collectionSpecie\": \"Example Species 2\"}]. "
...
# Processing the 'collectionSpecie' attribute
attribute = 'collectionSpecie'
info = species_info
print(f"Processing attribute: {attribute}")

# Define the specific fine-tuned model name for 'collectionSpecie' attribute
model_name = 'ft:gpt-4o-2024-08-06:eccenca-gmbh:ballena-specie-0-1st:AEZSpEnS'
...
# Define the backup file for 'collectionSpecie' attribute
...
# Define the main output filename for 'collectionSpecie' attribute
...
print("Processing complete for the 'collectionSpecie' attribute.")